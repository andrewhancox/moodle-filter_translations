...
$string['logexcludelang_desc'] = 'List of languages to skip from logging into missing translations table.<br>Comma separated values, eg: en,en_us<br>(Don\'t use space.)';
