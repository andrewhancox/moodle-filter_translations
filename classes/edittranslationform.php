...
class edittranslationform extends persistent {
    ...
    protected static $foreignfields = ['substitutetext_editor', 'substitutetext_format', 'substitutetexttrust'];
    ...
    protected function get_default_data() {
        ...
        $context = context_system::instance();
        $data = parent::get_default_data(); // TODO: Change the autogenerated stub
        ...
        $data = file_prepare_standard_editor($data, 'substitutetext', $this->get_substitute_test_editoroptions(), $context,
